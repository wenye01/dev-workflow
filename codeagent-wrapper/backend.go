...
func buildClaudeArgs(cfg *Config, targetArg string) []string {
	...
	args := []string{"-p"}
	if model := effectiveModel(cfg, "claude"); model != "" {
...
func buildGeminiArgs(cfg *Config, targetArg string) []string {
	...
	if model := effectiveModel(cfg, "gemini"); model != "" {
...
func (MockBackend) Command() string {
	return "mock"
}
func (MockBackend) BuildArgs(cfg *Config, targetArg string) []string {
	return nil
}
...
func effectiveModel(cfg *Config, backend string) string {
	...
	case "gemini":
		return strings.TrimSpace(cfg.GeminiModel)
	default:
